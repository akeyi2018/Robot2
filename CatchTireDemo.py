...
#face search initial
arm_def_position = [2020, 715, 1500, 845, 1225, 1000]
arm_cul_position = [2020, 715, 1500, 845, 1225, 1000]
...
aaaaaaaaaaaaaaaaaaaaab                pass
            

def catch():
    for i in range(4):
        base = arm_cul_position[2] + 10
        angle_ctrl(2, base)
    for i in range(7):
        angle_middle = arm_cul_position[1] +30
        angle_ctrl(1, angle_middle)
    for i in range(15):
        arm = arm_cul_position[5] + 21
        angle_ctrl(5, arm)
