...
arm_def_position = [2300, 1000, 1400, 600, 1400, 1500]
arm_cul_position = [2300, 1000, 1400, 600, 1400, 1500]
...
def Test01():
    ...
    maxp = [2290,1180,1400,910,1010,1350]
    for i in range(5,-1,-1):
        angle_ctrl(i, maxp[i])

    angle_ctrl(5, 2000)

    minp = [2290,1290,1400,1260,1510,1400]
    for i in range(5,-1,-1):
        angle_ctrl(i, minp[i])
